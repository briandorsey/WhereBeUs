...
{
	[self setTwitterUserId:(TwitterId)0 username:nil password:nil displayName:nil profileImageURL:nil];
}

- (void)clearFacebookCredentials
{
	[self setFacebookUserId:(FBUID)0 displayName:nil profileImageURL:nil];
}
